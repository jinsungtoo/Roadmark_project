...
class DetThread(QThread):
    ...
    def run(self,
        ...
        try:
            ...
            imgsz = (384,640)  # check image size
            names = {0: 'right_turn_no', 1: 'left_turn_no', 2: 'straight_no', 3: 'U_turn_no',
                                  4: 'safety_zone', 5: 'cross_alarm', 6: 'cross', 7: 'no_safe_left_turn', 8: 'slowly',
                                  9: 'yangbo', 10: 'gwasok_no', 11: 'limit30', 12: 'limit40', 13: 'limit50',
                                  14: 'limit60', 15: 'limit70', 16: 'limit80', 17: 'limit90'}
            if half:
                model.half()  # to FP16
            ...
            while True:
                ...
                if self.is_continue:
                    ...
                    label_dict = {0: 'right_turn_no', 1: 'left_turn_no', 2: 'straight_no', 3: 'U_turn_no',
                                  4: 'safety_zone', 5: 'cross_alarm', 6: 'cross', 7: 'no_safe_left_turn', 8: 'slowly',
                                  9: 'yangbo', 10: 'gwasok_no', 11: 'limit30', 12: 'limit40', 13: 'limit50',
                                  14: 'limit60', 15: 'limit70', 16: 'limit80', 17: 'limit90'}
                    statistic_dic = {label_dict[name]: 0 for name in names}
                    ...
                    for i, det in enumerate(pred):  # detections per image
                        ...
                        if len(det):
                            ...
                            for *xyxy, conf, cls in reversed(det):
                                ...
                                '''
                                # if True:
                                if x1 > 500 and x2 < 800 and y1 > 430 and y2 < 720:
                                    c = int(cls)  # integer class
                                    statistic_dic[names[c]] += 1
                                    k_label_dict = {0: '우회전금지', 1: '좌회전금지', 2: '직진금지', 3: '유턴금지', 4: '교통약자보호구역',
                                                    5: '횡단보도예고', 6: '횡단보도', 7: '비보호좌회전', 8: '천천히', 9: '양보',
                                                    10: '과속방지턱', 11: '속도제한30', 12: '속도제한40', 13: '속도제한50',
                                                    14: '속도제한60', 15: '속도제한70', 16: '속도제한80', 17: '속도제한90'}
                                    label = f'{k_label_dict[c]} {conf:.2f}'
                                    annotator.box_label(xyxy, label, color=colors(c, True))
                                if x1 > 352 and x2 < 947 and y1 > 570 and y2 <720:
                                    c = int(cls)  # integer class
                                    statistic_dic[names[c]] += 1
                                    k_label_dict = {0: '우회전금지', 1: '좌회전금지', 2: '직진금지', 3: '유턴금지', 4: '교통약자보호구역',
                                                    5: '횡단보도예고', 6: '횡단보도', 7: '비보호좌회전', 8: '천천히', 9: '양보',
                                    ...
                                    label = f'{k_label_dict[c]} {conf:.2f}'
                                    annotator.box_label(xyxy, label, color=colors(c, True))
                                if  x1 > 430 and x2 < 875 and y1 > 500 and y2 <720:
                                    c = int(cls)  # integer class
                                    statistic_dic[names[c]] += 1
                                    k_label_dict = {0: '우회전금지', 1: '좌회전금지', 2: '직진금지', 3: '유턴금지', 4: '교통약자보호구역',
                                                    5: '횡단보도예고', 6: '횡단보도', 7: '비보호좌회전', 8: '천천히', 9: '양보',
...
class MainWindow(QMainWindow, Ui_mainWindow):
    def __init__(self, parent=None):
        ...
        self.pt_list = [file for file in self.pt_list if file.endswith('.engine')]
    ...
    def search_pt(self):
        ...
        pt_list = [file for file in pt_list if file.endswith('.engine')]
    ...
    def show_statistic(self, statistic_dic):
        try:
            log_dict = {'right_turn_no': '우회전 금지 차선입니다.', 'left_turn_no': '좌회전 금지 차선입니다.',
                        'straight_no': '직진 금지 차선입니다.', 'U_turn_no': '유턴 금지 차선입니다.',
                        'safety_zone': '교통약자 보호구역입니다. \n 보행자에 주의하세요.',
                        'cross_alarm': '곧 횡단보도가 나옵니다. \n 보행자에 주의하세요.',
                        'cross': '횡단보도입니다. \n 보행자에 주의하세요.',
                        'no_safe_left_turn': '비보호 좌회전 차선입니다. \n 좌회전 시 교통상황에 주의하세요.',
                        'slowly': '서행구간입니다. \n 속도를 줄이세요.', 'yangbo': '양보 차선 입니다. \n 합류차량에 주의하세요.',
                        'gwasok_no': '과속방지턱입니다.', 'limit30': '속도제한 30km 구간입니다. \n 30km이하로 주행하세요',
                        'limit40': '속도제한 40km 구간입니다. \n 40km이하로 주행하세요',
                        'limit50': '속도제한 50km 구간입니다. \n 50km이하로 주행하세요',
                        'limit60': '속도제한 60km 구간입니다. \n 60km이하로 주행하세요',
                        'limit70': '속도제한 70km 구간입니다. \n 70km이하로 주행하세요',
                        'limit80': '속도제한 80km 구간입니다. \n 80km이하로 주행하세요',
                        'limit90': '속도제한 90km 구간입니다. \n 90km이하로 주행하세요'}
            self.resultWidget.clear()
            statistic_dic = sorted(statistic_dic.items(), key=lambda x: x[1], reverse=True)
            k_statistic = []
            for i in statistic_dic:
                if i[1] > 0:
                    k_statistic.append((log_dict[i[0]], i[1]))
            results = [' ' + str(i[0]) for i in k_statistic]
